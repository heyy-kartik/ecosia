    ...
    <div className="flex flex-row w-full min-h-screen">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-0.5 px-3 mb-4">
              ...
              <Link
                ...
                className="flex items-center gap-3 px-3 py-1.5 rounded-lg bg-white/10 transition"
              >
      ...
      >
        ...
        <p className="text-center text-sm text-muted-foreground max-w-2xl mx-auto mb-12">
          Your personalized climate education journey, gamified into levels and
          mastery stages.
        </p>
